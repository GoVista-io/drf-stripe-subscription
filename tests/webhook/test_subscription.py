...
class TestWebhookSubscriptionEvents(BaseTest):
    ...
    def test_event_handler_subscription_created(self):
        ...
        subscription = Subscription.objects.get(
            subscription_id="sub_1KHlYHL14ex1CGCiIBo8Xk5p"
        )
        ...
        self.assertEqual(
            sub_item.subscription.subscription_id, subscription.subscription_id
        )
    ...
    def test_event_handler_subscription_updated_price_plan_change(self):
        ...
        event = self._load_test_data(
            "2020-08-27/webhook_subscription_updated_billing_frequency.json"
        )
        handle_webhook_event(event)
        ...
        sub_item = SubscriptionItem.objects.get(
            price_id="price_1KHkCLL14ex1CGCieIBu8V2e"
        )
        self.assertEqual(
            sub_item.subscription.subscription_id, subscription.subscription_id
        )
    ...
    def test_event_handler_subscription_updated_coupon_added(self):
        ...
        event = self._load_test_data(
            "2020-08-27/webhook_subscription_updated_apply_coupon.json"
        )
        handle_webhook_event(event)
    ...
    def test_event_handler_subscription_updated_cancel_at_period_end(self):
        ...
        self.create_subscription()
        event = self._load_test_data(
            "2020-08-27/webhook_subscription_updated_cancel_at_period_end.json"
        )
        handle_webhook_event(event)
    ...
    def test_event_handler_subscription_updated_renewed(self):
        ...
        handle_webhook_event(event)
        event = self._load_test_data(
            "2020-08-27/webhook_subscription_updated_renew_plan.json"
        )
        handle_webhook_event(event)
    ...
    def test_event_handler_subscription_updated_cancel_immediately(self):
        ...
        self.create_subscription()
        event = self._load_test_data(
            "2020-08-27/webhook_subscription_updated_cancel_immediate.json"
        )
        handle_webhook_event(event)
